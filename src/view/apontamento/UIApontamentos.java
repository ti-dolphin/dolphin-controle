...
import model.apontamento.tables.ApontamentosTableModel;
...
public class UIApontamentos extends javax.swing.JInternalFrame {
    ...
    private Menu menu;
    private ApontamentosTableModel aTableModel = new ApontamentosTableModel();
    private ApontamentosPontoTableCellRender apTableCellRender;
    private ApontamentosTableCellRender aTableCellRender;
    private ApontamentoPontoTableModel apTableModel = new ApontamentoPontoTableModel();
    private DefaultListModel modelo = new DefaultListModel();
    private Apontamento apont;
    ...
    ArrayList<Apontamento> apontamentosPonto;
    ...
    public UIApontamentos(Apontamento apontamento) {
        initComponents();
        carregarComponentes();
        jtpPainelApontamentos.setSelectedIndex(1);
        carregarTabelaApontamentosPontoPorId(apontamento.getCodApont());
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(jtaApontamentos);
    ...
    public ApontamentosTableModel getaTableModel() {
        return aTableModel;
    }
    ...
    public Apontamento getApontamento() {
        return aTableModel.getApontamento(jtaApontamentos.getSelectedRow());
    }
            ...
            public void run() {
                try {
                    ...
                    for (Apontamento apontamentoPonto : apontamentosPonto) {
                        apTableModel.addRow(apontamentoPonto);
                    }
                    jtPonto.setModel(apTableModel);
                    configurarTabelaApontamentosPonto();
                    calcularNumeroDeRegistrosRetornados(apontamentosPonto.size());
                } catch (Exception ex) {
    ...
    private void carregarTabelaApontamentosPontoPorId(int id) {
        Menu.carregamento(true);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    apontamentosPonto = (ArrayList<Apontamento>) apontamentoService.filtrarApontamentosPontoPorId(id);
    ...
    private void carregarTabelaApontamentosPontoPorNotificacoesNaoLidas() {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    apTableModel.clear();
                    apontamentosPonto = (ArrayList<Apontamento>) apontamentoService.buscarPontosPorNotificacoesNaoLidas();
    ...
    private void configurarTabelaApontamentosPonto() {
        jtPonto.setRowSorter(new TableRowSorter<>(apTableModel));
        jtPonto.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_CHAPA).setPreferredWidth(50);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_NOME).setPreferredWidth(300);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_DATA).setPreferredWidth(100);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_STATUS).setPreferredWidth(65);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_VERIFICADO).setPreferredWidth(65);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_PROBLEMA).setPreferredWidth(65);
        jtPonto.getColumnModel().getColumn(apTableModel.COLUNA_AJUSTADO).setPreferredWidth(65);
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    apontamentos = dao.filtrarApontamento(query);
                    ...
                    calcularNumeroDeRegistrosRetornados(apontamentos.size());
    ...
    private void configurarTabelaApontamentos() {
        ...
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_DIA_DA_SEMANA).setPreferredWidth(150);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_GERENTE).setPreferredWidth(300);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_CENTRO_CUSTO).setPreferredWidth(350);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_STATUS).setPreferredWidth(100);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_LIDER).setPreferredWidth(350);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_ATIVIDADE).setPreferredWidth(350);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_SITUACAO).setPreferredWidth(100);
        jtaApontamentos.getColumnModel().getColumn(ApontamentosTableModel.COLUNA_ASSIDUIDADE).setPreferredWidth(100);
        aTableCellRender = new ApontamentosTableCellRender(aTableModel);
        jtaApontamentos.getColumnModel()
                .getColumn(ApontamentosTableModel.COLUNA_DATA)
    ...
    public void preencherComboBoxGerente() {
        PessoaDAO dao = DAOFactory.getPESSOADAO();
    ...
    public void preencherComboBoxStatusApont() {
    ...
    /**
     * Método usado para pegar apontamentos selecionados na tabela de
     * apontamentos
     *
     * @return List
     */
    public List<Apontamento> getApontamentosSelecionados() {
        List<Apontamento> apont = aTableModel.getApontamentos();
    ...
    /**
     * Método usado para apontar funcionários
     */
    public void abrirTelaApontamento() {
        if (aTableModel.getApontamento(jtaApontamentos.getSelectedRow()) != null) {
    ...
    private void pesquisar() {
        if (jtpPainelApontamentos.getSelectedIndex() == 0) {
            aTableModel.clear();
            carregarTabelaApontamentos();
        } else {
            apTableModel.clear();
    ...
    }//GEN-LAST:event_jtaApontamentosMouseClicked
    ...
    private void jbApontarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbApontarActionPerformed
        if (jtaApontamentos.getSelectedRowCount() > 1) {
    ...
    private void jbExportarExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExportarExcelActionPerformed
        ...
        new Thread(() -> {
            try {
                ...
                ArrayList<Apontamento> aponts = dao.filtrarApontamento(query);
