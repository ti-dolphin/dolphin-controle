...
public class EpiTableModel extends AbstractTableModel{
    ...
    private String[] colunas = {"Código", "Nome", "Preço", "Periodicidade", "Descrição"};
    
    public final int COLUNA_CODIGO = 0;
    public final int COLUNA_NOME = 1;
    public final int COLUNA_PRECO = 2;
    public final int COLUNA_PERIODICIDADE = 3;
    public final int COLUNA_DESCRICAO = 4;
    ...
    public Object getValueAt(int linha, int coluna) {
        switch(coluna){
            ...
            case COLUNA_PERIODICIDADE:
                return epis.get(linha).getPeriodicidade();
